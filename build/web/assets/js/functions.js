...
(function($) {
    ...
    var ThemeBuilder = function() {
        ...
        // Thêm hàm mới để quản lý Our Gallery
        var manageImageViewer = function() {
            if (!checkSelectorExistence('.gallery-img')) { return; }
            ...
            window.openImageViewer = function(src, title) {
                ...
                if (viewer && fullImage && caption) {
                    fullImage.src = src;
                    caption.textContent = title || "Không có tiêu đề";
        ...
        return {
            initialHelper: function() {
                ...
                setStylishScroll();
                manageLeftSideMenu();
                manageImageViewer(); // Thêm hàm mới vào đây
            },
