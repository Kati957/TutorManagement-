...
<head>
    ...
    <title>G4 SmartTutor : Request Password</title>
        ...
        <div class="account-form-inner">
            <div class="account-container">
                <div class="heading-bx left">
                    <h2 class="title-head">Request <span>Password</span></h2>
                ...
                <form class="contact-bx" action="requestPassword" method="POST">
                    <div class="row placeani">
                        ...
                        <div class="col-lg-12 m-b30">
                            <button type="submit" class="btn button-md">Request Password</button>
                        </div>
                    </div>
                </form>
            </div>
