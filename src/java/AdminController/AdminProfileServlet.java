...
@WebServlet(name = "AdminProfileServlet", urlPatterns = {"/admin/myprofile"}) // Thay đổi từ /admin/profile thành /admin/myprofile
...
public class AdminProfileServlet extends HttpServlet {
    ...
    private void handleChangePassword(HttpServletRequest request, HttpServletResponse response,
        ...
        try {
            ...
            response.sendRedirect(request.getContextPath() + "/admin/myprofile"); // Cập nhật redirect
        }
    }
