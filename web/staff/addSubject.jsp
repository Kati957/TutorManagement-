        ...
        <main class="ttr-wrapper">
            <div class="container-fluid">
                <div class="db-breadcrumb">
                    <h4 class="breadcrumb-title"><fmt:message key="add_subject"/></h4>
                    <ul class="db-breadcrumb-list">
                        <li><a href="${pageContext.request.contextPath}/staff/dashboard"><i class="fa fa-home"></i><fmt:message key="home"/></a></li>
                        <li><a href="${pageContext.request.contextPath}/staff/SubjectController?service=listSubject"><fmt:message key="subject_management"/></a></li>
                        <li><fmt:message key="add_subject"/></li>
                    </ul>
                </div>
                <div class="row">
                    <div class="col-lg-6 m-b30">
                        <div class="widget-box">
                            <div class="wc-title">
                                <h4><fmt:message key="add_new_subject"/></h4>
                            </div>
                            <div class="widget-inner">
                                <c:if test="${not empty sessionScope.error}">
                                    <div style="color: red;"><fmt:message key="${sessionScope.error}"/></div>
                                    <c:remove var="error" scope="session" />
                                </c:if>
                                <form action="${pageContext.request.contextPath}/staff/SubjectController?service=addSubject" method="post">
                                    ...
                                    <button type="submit" name="submit" class="submit-btn"><fmt:message key="add_subject"/></button>
                                </form>
                            </div>
                        </div>
                    </div>
