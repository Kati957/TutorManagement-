...
<html lang="en">
    <head>
        ...
        <!-- PAGE TITLE -->
        <title>G4 SmartTutor - User & Tutor Logs</title>
            ...
            <div class="ttr-header-wrapper">
                ...
                <div class="ttr-header-right ttr-with-seperator">
                    ...
                    <ul class="ttr-header-navigation">
                        <li>
                            <a href="staffprofile" class="ttr-material-button ttr-submenu-toggle">
                ...
                <nav class="ttr-sidebar-navi">
                    <ul>
                        ...
                        <li>
                            ...
                            <ul>
                                <li><a href="BlogController?service=listBlog" class="ttr-material-button"><span class="ttr-label">Blog</span></a></li>
                                <li><a href="BlogController?service=addBlog" class="ttr-material-button"><span class="ttr-label">Add Blog</span></a></li>
                            </ul>
                        </li>
                        <li>
                ...
                <div class="row">
                    <div class="col-lg-12 m-b30">
                        <div class="widget-box">
                            <div class="wc-title">
                                <h4>User & Tutor Access Log History</h4>
                            </div>
                                    ...
                                    <tbody>
                                        <%
                                            for (HistoryLog log : logs) {
                                                String roleName = log.getRoleId() == 2 ? "User" : (log.getRoleId() == 3 ? "Tutor" : "N/A");
                                        %>
                                        <tr>
                                            <td><%= roleName %></td>
