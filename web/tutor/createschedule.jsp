                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <c:choose>
                                    <c:when test="${not empty scheduleList}">
                                        <c:forEach var="schedule" items="${scheduleList}">
                                            <tr>
                                                ...
                                                <td>
                                                    <fmt:formatDate value="${schedule.startTime}" pattern="HH:mm 'on' dd/MM/yyyy" />
                                                </td>
                                                <td>
                                                    <fmt:formatDate value="${schedule.endTime}" pattern="HH:mm 'on' dd/MM/yyyy" />
                                                </td>
                                    ...
                                    <c:otherwise>
                                        <tr>
                                            <td colspan="4" class="text-center"><fmt:message key="no_schedule_yet"/></td>
                                        </tr>
                                    </c:otherwise>
                                </c:choose>
                            </tbody>
