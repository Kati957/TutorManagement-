...
<head>
    ...
    <title>G4 SmartTutor - Yêu Cầu Rút Tiền</title>
                                        ...
                                        <div class="ttr-post-content">
                                            ...
                                            <c:if test="${not empty months}">
                                                <form method="post" action="${pageContext.request.contextPath}/tutor/withdrawRequest" class="form-container">
                                                    ...
                                                    <input type="submit" value="Gửi Yêu Cầu Rút Tiền">
                                                </form>
                                            </c:if>
                                            ...
                                            <div class="mt-3">
                                                <a href="${pageContext.request.contextPath}/tutor/bookingHistory" class="back-link">Quay lại Lịch Sử Booking</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
