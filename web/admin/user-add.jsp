        ...
        <main class="ttr-wrapper">
            <div class="container-fluid">
                <div class="db-breadcrumb">
                    <h4 class="breadcrumb-title"><fmt:message key="${editUser != null ? 'edit_user' : 'add_new_user'}"/></h4>
                    <ul class="db-breadcrumb-list">
                        <li><a href="${pageContext.request.contextPath}/admin/index"><i class="fa fa-home"></i><fmt:message key="home"/></a></li>
                        <li><fmt:message key="${editUser != null ? 'edit_user' : 'add_new_user'}"/></li>
                    </ul>
                </div>	
                <div class="row">
                    <div class="col-lg-12 m-b30">
                        <div class="widget-box">
                            <div class="wc-title">
                                <h4><fmt:message key="${editUser != null ? 'edit_user' : 'add_new_user'}"/></h4>
                            </div>
                                ...
                                <form action="${pageContext.request.contextPath}/admin/UserManage" method="POST" class="contact-bx" enctype="multipart/form-data">
                                    ...
                                    <div class="row placeani">
                                        <c:if test="${not empty requestScope.error}">
                                            <div class="col-lg-12"><p class="text-danger"><fmt:message key="error"/>: ${requestScope.error}</p></div>
                                        </c:if>
                                        <c:if test="${not empty sessionScope.success}">
                                            <div class="col-lg-12"><p class="text-success"><fmt:message key="success"/>: ${sessionScope.success}</p></div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <label><fmt:message key="date_of_birth"/></label>
                                        ...
                                        <div class="col-lg-12 m-b30">
                                            ...
                                            <a href="${pageContext.request.contextPath}/admin/UserList" class="btn btn-secondary"><fmt:message key="cancel"/></a>
                                        </div>
                                    </div>
                                </form>
                            </div>
