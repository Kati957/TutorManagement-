...
<html lang="${sessionScope.locale != null ? sessionScope.locale : 'en'}">
    <head>
        ...
        <style>
            ...
            .col-lg-12 { flex: 0 0 100%; max-width: 100%; padding-right: 15px; padding-left: 15px; box-sizing: border-box; }
            .m-b30 { margin-bottom: 30px; }
            .widget-box { background: #fff; border: 1px solid #e5e5e5; border-radius: 4px; box-shadow: 0 1px 1px rgba(0, 0, 0, 0.05); margin-bottom: 30px; }
            .wc-title { padding: 15px; border-bottom: 1px solid #e5e5e5; }
        ...
        <main class="ttr-wrapper">
            <div class="container-fluid">
                ...
                <div class="db-breadcrumb">
                    <h4 class="breadcrumb-title"><fmt:message key="view_history_payment"/></h4>
                    <ul class="db-breadcrumb-list">
                        <li><a href="${pageContext.request.contextPath}/admin/index"><i class="fa fa-home"></i><fmt:message key="home"/></a></li>
                        <li><fmt:message key="payment"/></li>
                        <li><fmt:message key="view_history_payment"/></li>
                    </ul>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12 m-b30">
                        <div class="widget-box">
                            <div class="wc-title">
                                <h4><fmt:message key="view_history_payment"/> (Admin)</h4>
                            </div>
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    <thead>
                                        <tr>
                                            <th><fmt:message key="transaction_id"/></th>
                                            <th><fmt:message key="booking_id"/></th>
                                            <th><fmt:message key="student"/></th>
                                            <th><fmt:message key="email"/></th>
                                            <th><fmt:message key="amount"/></th>
                                            <th><fmt:message key="promotion_id"/></th>
                                    ...
                                    <tbody>
                                        <c:forEach var="payment" items="${paymentHistory}">
                                            <tr>
                                                ...
                                                <td>${payment.promotionID == 0 ? fmt.message(key='none') : payment.promotionID}</td>
                                        ...
                                        <c:if test="${empty paymentHistory}">
                                            <tr>
                                                <td colspan="8" class="text-center"><fmt:message key="no_transactions_found"/></td>
                                            </tr>
                                        </c:if>
                                    </tbody>
                                </table>
