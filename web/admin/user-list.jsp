...
<html lang="${sessionScope.locale != null ? sessionScope.locale : 'en'}">
    <head>
        ...
        <title>G4 SmartTutor - <fmt:message key="user_list"/></title>
                ...
                <div class="row">
                    <div class="col-lg-12 m-b30">
                        <div class="widget-box">
                            <div class="wc-title">
                                <h4><fmt:message key="user_list"/></h4>
                            </div>
                                    ...
                                    <tbody>
                                        <c:forEach var="user" items="${userList}">
                                            <tr>
                                                ...
                                                <td>${user.createAt}</td>
                                                <td>
                                                    <a href="${pageContext.request.contextPath}/admin/UserManage?edit=${user.userID}" class="btn btn-primary btn-sm"><fmt:message key="edit"/></a>
                                                    <c:choose>
                                                        <c:when test="${user.isActive == 1}">
                                                            <button class="btn btn-danger btn-sm deactivateUserBtn" data-id="${user.userID}"><fmt:message key="deactivate"/></button>
                                                        </c:when>
                                                        <c:otherwise>
                                                            <button class="btn btn-success btn-sm activateUserBtn" data-id="${user.userID}"><fmt:message key="activate"/></button>
                                                        </c:otherwise>
                                                    </c:choose>
                                                </td>
                                                <td>
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="userModalLabel-${user.userID}"><fmt:message key="user_details"/>: ${user.fullName}</h5>
                                        ...
                                        <c:if test="${empty userList}">
                                            <tr><td colspan="6"><fmt:message key="no_users_found"/></td></tr>
                                        </c:if>
                                    </tbody>
                                </table>
                            </div>
