...
<html lang="${sessionScope.locale != null ? sessionScope.locale : 'en'}">
    <head>
        ...
        <!-- PAGE TITLE -->
        <title>G4 SmartTutor - <fmt:message key="subject_management"/></title>
                    ...
                    <div class="col-lg-12 m-b30">
                        <div class="widget-box">
                            <div class="wc-title">
                                ...
                                <a href="${pageContext.request.contextPath}/admin/AdminSubjectController?service=addSubject" class="btn" style="margin-top: 6px;"><fmt:message key="add_subject"/></a>
                            </div>
                            <!-- Hiển thị thông báo -->
