                                ...
                                <tbody>
                                    <c:forEach var="booking" items="${bookingList}">
                                        <tr>
                                            ...
                                            <td class="${booking.status == 'Confirmed' ? 'status-confirmed' : booking.status == 'Completed' ? 'status-completed' : 'status-refunded'}">${booking.status}</td>
                                            ...
                                            <td>
                                                <c:if test="${booking.status == 'Completed'}">
                                                    <form action="${pageContext.request.contextPath}/admin/ViewBooking" method="post" style="display:inline;">
                                                        ...
                                                        <button type="submit" class="refund-btn" onclick="return confirm('Are you sure you want to refund Booking ID ${booking.bookingID}?')">Refund</button>
                                                    </form>
                                                </c:if>
                                            </td>
                                        </tr>
