                        ...
                        <div class="widget-box">
                            ...
                            <div class="widget-inner">
                                <table class="table table-striped">
                                    ...
                                    <p>Debug: Staff list size: ${staffList.size()}</p>
                                    <p>Debug: Is staffList null? ${staffList == null}</p>
                                    <p>Debug: Raw staffList: ${staffList}</p>
                                    <c:forEach var="user" items="${staffList}">
                                        <tr>
                                            ...
                                            <td>
                                                <a href="${pageContext.request.contextPath}/admin/StaffRegister?edit=${user.userID}" class="btn btn-primary btn-sm">Edit</a>
                                                <button class="btn btn-danger btn-sm deleteStaffBtn" data-id="${user.userID}">Delete</button>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                    <c:if test="${empty staffList}">
                                        <tr><td colspan="8">No staff members found.</td></tr>
                                    </c:if>
                                    </tbody>
                                </table>
                            </div>
            ...
            document.querySelectorAll('.deleteStaffBtn').forEach(button => {
                button.addEventListener('click', function () {
                    if (confirm('Are you sure you want to delete this staff member?')) {
                        ...
                        window.location.href = '${pageContext.request.contextPath}/admin/StaffList?delete=' + userID;
                    }
                });
            });
        </script>
