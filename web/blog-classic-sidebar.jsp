        ...
        <div class="page-wraper">
                ...
                <div class="page-banner ovbl-dark" style="background-image:url(assets/images/banner/banner1.jpg);">
                    <div class="container">
                        <div class="page-banner-entry">
                            <h1 class="text-white"><fmt:message key="blog"/></h1>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-8 col-xl-8 col-md-7">
                                    <div id="masonry" class="ttr-blog-grid-3 row">
                                        ...
                                        <div class="post action-card col-xl-6 col-lg-6 col-md-12 col-xs-12 m-b40">
                                            <div class="recent-news">
                                                ...
                                                <div class="info-bx">
                                                    ...
                                                    <h5 class="post-title">
                                                        <a href="ViewBlog?service=detailBlog&blogID=<%= blog.getBlogID()%>"><%= blog.getTitle()%></a>
                                                    </h5>
                                                    <p><%= blog.getSummary()%></p>
                                                </div>
                                            </div>
                                        ...
                                        %>
                                        <p><fmt:message key="no_posts_available"/></p>
                                        <%
                                            }
                                        %>
                                    </div>
            ...
            <script>
                                                document.addEventListener('DOMContentLoaded', function () {
                                                    console.log('Trang blog-classic-sidebar đã load xong');
